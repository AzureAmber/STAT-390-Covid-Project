...
arima_recipe <- recipe(new_cases ~ date, data = train_germ)
...
save(arima_tuned, file = "Models/erica/results/arima_tuned_germ_1.rda")

# 6. Results
arima_germ_autoplot <- autoplot(arima_tuned, metric = "rmse")

save(arima_germ_autoplot, file = "Models/erica/results/arima_germ_autoplot.jpeg")

show_best(arima_tuned, metric = "rmse") #with RMSE: 56152

## BEST MODEL HYPERPARAMTER: p,d,q: 2,1,2; P,D,Q: 1,1,1; 