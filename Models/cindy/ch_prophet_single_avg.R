...
#              27             0.667                0.00293             25.6                    0.00109 rmse   
#              38             0.807               99.8                  0.0301                 0.00134 rmse   
#              42             0.768                0.0140              39.1                    0.00395 rmse   
#              17             0.635                7.85                 0.190                  0.00104 rmse   
#              42             0.634                0.0984               0.00101                0.00745 rmse  

# changepoint_num = 27, changepoint_range = 0.667, prior_scale_changepoint = 0.00109
#       prior_scale_holidays = 25.6, prior_scale_seasonality = 0.00293
...
for(country in unique_countries) {
  ...
  prophet_country <- ggplot(prophet_train_results %>% filter(location == country)) +
    ...
    labs(x = "Date",
         y = "New Cases",
         title = plot_name,
         subtitle = "prophet_reg(changepoint_num = 27, changepoint_range = 0.667,
         prior_scale_changepoints = 0.00109, prior_scale_seasonality = 0.00293, prior_scale_holidays = 25.6)",
