...
-   Large amount of missing data for predictor variables (ie. **vaccination**, **hospital**, **icu**) in earliest time and more recent data reporting. Trying to narrow down on a time period where at least 60% of data cumulatively is not missing and then apply propoer imputation; meanwhile, find if these variables are highly correlated by checking correlation matrix
