...
-   Will use clustering with `life_expectancy` to make predictions for some missing values and then impute predictor variables like vaccination, extreme poverty and icu units with cluster median/mode. 
